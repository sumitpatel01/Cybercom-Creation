<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if (!$nameErr && !$passErr && !$addressErr && !$genderErr && !$ageErr && !$fileErr && !$gameErr) {
            ...
            $sql = "INSERT INTO `form1` (`name`, `pwd`, `gender`, `address`, `age group`, `games`) VALUES ('$username', '$password', '$gender', '$address', '$age', '$games')";
            $result = mysqli_query($conn, $sql);
            

        $table_content = '<table class=\"tab\"><tr><th colspan=\"2\">Your form details:</th><tr><td>Name</td><td>'. $username .'</td></tr><tr><td>password</td><td>'. $password .'</td></tr><tr><td>address</td><td>'. 
        $address .'</td></tr><tr><td>gender</td><td>'. $gender .'</td></tr><tr><td>age</td><td>'. $age .'</td></tr><tr><td>files</td><td>'.
         $file['name'] .'</td></tr><tr><td>Games</td><td>'.$games.'</td></tr></table>';
