...
$nameErr = $lastnameErr = $passErr = $cpassErr = $countryErr = $genderErr = $phoneErr = $emailErr = $dobErr = $agreeErr ="";
...
if(isset($_POST['submit'])){
	...
	if (!$nameErr && !$lastnameErr && !$passErr && !$cpassErr && !$countryErr && !$genderErr && !$phoneErr && !$emailErr && !$dobErr) {
		$dobValue = $year.'-'.$month.'-'.$date;
		$sql = "INSERT INTO `form3` (`firstname`, `lastname`, `password`, `confirm password`, `DOB`, `gender`, `email`, `phone`, `country`) VALUES ('$firstName', '$lastName', '$password', '$cpassword', '$dobValue', '$gender', '$email', '$phone', '$country');";
        $result = mysqli_query($conn, $sql);

		$table_content = '<table class=\"tab\"><tr><th colspan=\"2\">Your form details:</th><tr><td>First Name</td><td>'. $firstName .'<tr><td>last Name</td><td>'. $lastName .'</td></tr><tr><td>Password</td><td>'. $password .'</td></tr><tr><td>Confirm Password</td><td>'. $cpassword .'</td></tr><tr><td>country</td><td>'. 
...
<form action="form3.php" method="post" onsubmit= "return validateForm()">
        ...
        <tr>
            <td>Last Name</td>
            <td><input type="text" name="lname" id="lname" value= " <?php echo $lastName;?>">
            <div class="error" id="lnameErr"><?php echo $lastnameErr; ?></div></td>
        </tr>
        <tr>
            <td>
            DATE OF BIRTH
        ...
        <tr>
          ...
          <td>
                ...
                <div class="error" id="countryErr"><?php echo $countryErr; ?></div>
          </td>
        </tr>
            <td>E-Mail</td>
            <td><input type="email" name="email" id="email">
            <div class="error" id="emailErr"><?php echo $emailErr; ?></div></td>
        ...
        <tr>
            ...
            <div class="error" id="phoneErr"><?php echo $phoneErr; ?></div></td>
        </tr>
        <tr>
            <td>Password</td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <div class="error" id="cpassErr"><?php echo $cpassErr; ?></div>
            </td>
        </tr>
        <tr>
            <td></td>
