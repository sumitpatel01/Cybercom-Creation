...
<fieldset>
    ...
    <form action="form2.php" method="post" onsubmit="return validateForm()">
        ...
        <tr>
            ...
            <div class="error" id="passErr"></div></td>
        </tr>
        <tr>
            <td>GENDER</td>
            <td>
                <input type="radio" name="gender" id="male" value="male">male 
                <input type="radio" name="gender" id="feamle" value="female">female
        ...
        <tr>
            ...
            <div class="error" id="addErr"></div></td>
        </tr>
        <tr>
            <td>
            DATE OF BIRTH
        ...
        <tr>
            ...
            <td>
                ...
                <div class="error" id="maritalErr"></div>
            </td>
        </tr>
        <tr>
            <td></td>
        ...
        if(isset($_POST['submit'])){
            ...
            echo '<tr><td>First Name</td><td>'. $username .'</td></tr><tr><td>Password</td><td>'. $password .'</td></tr><tr><td>address</td><td>'. 
