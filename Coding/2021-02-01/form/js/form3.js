...
function validateForm () {
    ...
    var nameErr = lnameErr = cpassErr= passErr = addErr = ageErr = genderErr = dobErr = fileErr= true;
    ...
    if(email.value == "") {
        printError("emailErr", "Please enter your email country");
    } else {
        // Regular expression for basic email validation
        var regex = /^\S+@\S+\.\S+$/;
        if(regex.test(email.value) === false) {
            printError("emailErr", "Please enter a valid email country");
        } else{
            printError("emailErr", "");
            emailErr = false;
        }
    ...
    if((nameErr || passErr || emailErr || lnameErr || dobErr || genderErr || cpassErr || countryErr || phoneErr ) == true) {
        return false;
     } else {
